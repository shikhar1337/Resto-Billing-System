  ...
  <div class="container">
    ...
    <div class="row">
        ...
        <table id="tb-veg" class="uk-table uk-table-divider">
          <thead>
            <th> <span>Pasta Name </span> </th>
            <th> <span>Category </span> </th>
            <th> <span>Price </span> </th>
          </thead>
            <tbody >
              <tr v-for="pasta in pastas">
                <td><span>{{pasta.name}}</span></td>
                <td><span class="uk-label" v-bind:class="setCategory(pasta.category)">{{pasta.category}}</span></td>
                <td><span>{{pasta.price }}</span></td>
                <td><button class="uk-button uk-button-secondary" href="#modal-center" uk-toggle v-on:click="setData(pasta.name,pasta.price,pasta.id)">Add to Cart</button></td>
                <td></td>
              </tr>
            </tbody>
        </table>
...
export default {
  ...
  computed:{
    pastas(){
      return this.$store.getters.getPastas
    }
  }
}
</script>
